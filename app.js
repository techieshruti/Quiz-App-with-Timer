...
container.style.background =
  "linear-gradient(to right top, #0f2027, #203a43, #2c5364)";
...
quizScreen.style.background = "linear-gradient(to right, #fdfbfb, #ebedee)";
...
const questions = [
  ...
  {
    question:
      "3. What will be the output of the following code snippet? console.log(typeof(NaN));",
  ...
  {
    question:
      "13. Which built-in method calls a function for each array element?",
...
function renderQuestion() {
  ...
  question.options.forEach((optionText) => {
    ...
    btn.style.border = "none";
    btn.style.backgroundColor = "#f1c927ff";
    ...
    btn.addEventListener("click", () => {
      ...
      if (optionText === question.correct) {
        score++;
        btn.style.backgroundColor = "#3ab146ff"; // green
        btn.style.color = "#000";
        btn.style.boxShadow = "0 0 15px #6ee57aff";
        playCorrectSound();
      } else {
        btn.style.backgroundColor = "#f55353ff"; // red
        btn.style.color = "#000";
        btn.style.boxShadow = "0 0 15px #f55353ff";
        playWrongSound();
      }
...
// PLAY CLAPING END OF QUIZ
function playClapScound() {
...
feedbackMsg.style.fontSize = "1.8rem";
feedbackMsg.style.marginBottom = "1rem";
